...
with tab_sim:
    ...
    with e1:
        cidade_sim_default = 'São Paulo' if modo_brasil else cidade_sel
        idx_sim = cidades.index(cidade_sim_default) if cidade_sim_default in cidades else 0
        cid_in = st.selectbox("Cidade", cidades, index=idx_sim, key="sim_cidade")
